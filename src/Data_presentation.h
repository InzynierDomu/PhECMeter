#ifndef DATA_PRESENTATION
#define DATA_PRESENTATION
...
public:
	...
	void display_calibration_ec(const int sample, const int position, const float temperature);

private:
  Adafruit_SSD1306 m_display;
};

#endif //DATA_PRESENTATION